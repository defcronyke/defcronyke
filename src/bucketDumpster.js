        ...
        <div>
          ...
          <Link to="/">
            <img
              ...
              alt="A pile of snow completely filling in a small fenced in back yard, covering a table and a barbecue."
            />
          </Link>
          ...
          <div className="links">
            ...
            <iframe
              title="Bucket Dumpster by Defcronyke, embedded from YouTube."
              width="560"
              height="315"
              src="https://www.youtube.com/embed/videoseries?list=PLA9w7gX4C1R0tDamHoKyDiEiprE20zzGL"
              frameBorder="0"
            ...
            <ul>
              <li>
                <a
                  href="https://defcronyke.bandcamp.com/album/bucket-dumpster"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://play.google.com/store/music/album/Defcronyke_Bucket_Dumpster?id=Bf6ga7tcleaxeyfxkh2t2jyvc2m"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://itunes.apple.com/us/album/bucket-dumpster/1448800141?app=itunes&ign-mpt=uo%3D4"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Buy on iTunes
              ...
              <li>
                <a
                  href="https://www.amazon.com/gp/product/B07M7BFHVT"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Buy on Amazon
              ...
              <li>
                <a
                  href="https://www.youtube.com/playlist?list=PLA9w7gX4C1R0tDamHoKyDiEiprE20zzGL"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stream on YouTube
              ...
              <li>
                <a
                  href="https://soundcloud.com/defcronyke/sets/bucket-dumpster"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://audiomack.com/album/defcronyke/bucket-dumpster"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stream on Audiomack
              ...
              <li>
                <a
                  href="https://open.spotify.com/album/3VShQOjY5gGFzOfyz5Rdxb"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stream on Spotify
              ...
              <li>
                <a
                  href="https://itunes.apple.com/us/album/bucket-dumpster/1448800141?app=apple%20music&ign-mpt=uo%3D4"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a
                  href="https://www.deezer.com/en/album/83669312"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stream on Deezer
              ...
              <li>
                <a
                  href="https://listen.tidal.com/album/102017257"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stream on Tidal
              ...
              <li>
                <a
                  href="https://www.kkbox.com/hk/en/album/AxsPJoyWLyKdT0F2keUI009H-index.html"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Stream on KKBox
              ...
              <li>
                <a
                  href="https://archive.org/details/BucketDumpster"
                  target="_blank"
                  rel="noopener noreferrer"
                >
